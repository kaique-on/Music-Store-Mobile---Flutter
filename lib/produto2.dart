...
class Produto2 extends StatelessWidget {
  const Produto2({super.key});
      ...
      body: ListView(
        children: [
          ...
          const SizedBox(
            ...
            child: Image(image: AssetImage('assets/guitarra2.webp'))),

            const Padding(
              padding: EdgeInsets.all(16.0),
              child: Text('Guitarra Squier Stratocaster Affinity FMT HSS - Black Sun', style: TextStyle(fontSize: 22),),
            ),
            ...
            Padding(
              ...
              child: Text('R\$ 3.361,00', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Colors.green), ),
            ),
